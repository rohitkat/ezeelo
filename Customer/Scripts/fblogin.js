//https://disqus.com/by/pradnyakar/
window.fbAsyncInit = function () {
    //FB.init({
    //    appId: '1685609821721578', // Set YOUR APP ID
...
function getUserInfo() {
    FB.api('/me', { fields: 'name,email' }, function (response) {
        ...
        str += getPhoto();// "<input type='button' value='Get Photo' onclick='getPhoto();'/>";
        ...
        var useName = response.username;


        /*Add For Insert Email in DataBase*/
        $.ajax({
