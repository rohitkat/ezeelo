...
namespace Merchant.Controllers
{
    public class CancelledController : Controller
    {
        ...
        private long GetShopID()
        {
            ...
            {
                throw new BusinessLogicLayer.MyException("[CancelledController][GetShopID]", "Can't find ShopID !" + Environment.NewLine + ex.Message);
            }
            return ShopID;
        }
        private long GetPersonalDetailID()
        {
            ...
            {
                throw new BusinessLogicLayer.MyException("[CancelledController][GetShopID]", "Can't find PersonalDetailID !" + Environment.NewLine + ex.Message);
            }
            return PersonalDetailID;
        }
        // GET: /Cancelled/
        [SessionExpire]
        [Authorize(Roles = "Cancelled/CanRead")]
        public ActionResult Index()
        {
            ...
            try
            {
                ...
                where COD.ShopID.Equals(ShopID) && COD.OrderStatus.Equals((int)ORDER_STATUS.CANCELLED)
                select new
                {
                    CO.OrderCode,
                    COD.ShopOrderCode,
