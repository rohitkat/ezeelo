...
namespace Merchant.Controllers
{
    ...
    public class ProductUploadTempController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            try
            {
                ...
                foreach (var ReadRecord in QueryResult)
                {
                    ...
                    // putvm.ImageLocation = MerchantCommonFunction.FindProductDefaultImageLocation1(ReadRecord.ProductID);
                    ...
                    {
                        putvm.ImageLocation = ImageDisplay.SetProductThumbPath(ReadRecord.ProductID, colorName.Name, string.Empty, ProductUpload.IMAGE_TYPE.NonApproved);
                    }
            ...
            try
            {
                ...
                if (IsIdPresent != null)
                {
                    var productComp = (from tsc in db.TempStockComponents
                                       ...
                                       //join u in db.Units on tsc.ComponentUnitID equals u.ID into u_join
                                       //from u in u_join.DefaultIfEmpty()                                      
        ...
        List<HttpPostedFileBase> files_0, List<HttpPostedFileBase> files_1, List<HttpPostedFileBase> files_2, List<HttpPostedFileBase> files_3, List<HttpPostedFileBase> files_4, List<HttpPostedFileBase> files_5, List<HttpPostedFileBase> files_6, List<HttpPostedFileBase> files_7, List<HttpPostedFileBase> files_8, List<HttpPostedFileBase> files_9, List<HttpPostedFileBase> files_10, List<HttpPostedFileBase> files_11, List<HttpPostedFileBase> files_12, List<HttpPostedFileBase> files_13, List<HttpPostedFileBase> files_14, List<HttpPostedFileBase> files_15, string submit, string DisplayProductFromDate1, string textarea, List<CategorySpecificationList> CategorySpecificationList)
        {
            ...
            //TaxationManagement lTaxationManagement = new TaxationManagement();
                        ...
                        if (Proresult == 0)
                        {
                            using (TransactionScope ts = new TransactionScope())
                            {
                                try
                                {
                                    ...
                                    //productuploadtempviewmodel.CategoryID = Convert.ToInt32(ddlCategoryLevel2);
                                    ...
                                    TSP.ProductID = TP.ID;
                                    TSP.IsActive = true;
                                    TSP.DisplayProductFromDate = productuploadtempviewmodel.DisplayProductFromDate.AddHours(5.5);
                    ...
                    case "Save":
                        using (TransactionScope ts = new TransactionScope())
                        {
                            try
                            {
                                ...
                                {
                                    ModelState.AddModelError("Error", "There's Something wrong with Edit description!!");
                                ...
                                catch (Exception ex)
                                {
                                    ...
                                    ModelState.AddModelError("Error", "There's Something wrong with with description!!");
        ...
        public ActionResult VariantImage(string ProductVarientImageID)
        {

            ProductUploadTempViewModel productuploadtempviewmodel = new ProductUploadTempViewModel();
            ViewBag.ProductVarientImageID = ProductVarientImageID;
            string[] a1 = ProductVarientImageID.Split('$');

            string[] src = ImageDisplay.DisplayProductImages(Convert.ToInt64(a1[1]), "Default", string.Empty, ProductUpload.THUMB_TYPE.SD, ProductUpload.IMAGE_TYPE.NonApproved);
            ViewBag.ImageURL = src;
            productuploadtempviewmodel.Path = src;
            return View(productuploadtempviewmodel);
        }
        [HttpPost]
        public ActionResult VariantImage(List<HttpPostedFileBase> files_0, List<HttpPostedFileBase> files_1)
        {
            return View();
        }
        ...
        public ActionResult Remove(long? id)
        {
            ...
            return RedirectToAction("Edit", new { ID = tempProductVarient.ProductID });
        ...
        public JsonResult AutoCompleteProName(string term)
        {
            long ShopID = GetShopID();
        ...
        public JsonResult AutoCompleteProName1(string term)
        {
            long ShopID = GetShopID();
        ...
        //========================================
        [SessionExpire]
        public ActionResult GBCatalog1(long id)
        {
            ProductUploadTempViewModel productuploadtempviewmodel = new ProductUploadTempViewModel();
            long ShopID = GetShopID();
            long PersonalDetailID = GetPersonalDetailID();
