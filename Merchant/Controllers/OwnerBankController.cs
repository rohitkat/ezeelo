...
namespace Merchant.Controllers
{
    public class OwnerBankController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,BusinessTypeID,OwnerID,AccountName,BankID,BranchName,IFSCCode,MICRCode,AccountNumber,BankAccountTypeID,IsActive,CreateDate,CreateBy,ModifyDate,ModifyBy,NetworkIP,DeviceType,DeviceID")] OwnerBank ownerbank)
        {
            ...
            ob.BusinessTypeID = 1; // ownerbank.BusinessTypeID;
