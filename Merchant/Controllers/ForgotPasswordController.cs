    ...
    public class ForgotPasswordController : Controller
    {
        ...
        private void SendPassword(string pEmailId, long userLoginID)
        {
            try
            {
                ...
                dictionary.Add("<!--ACCOUNT_URL-->", "" + (new URLsFromConfig()).GetURL("MERCHANT") + "");
                dictionary.Add("<!--ORDERS_URL-->", "" + (new URLsFromConfig()).GetURL("MERCHANT") + "placed");
                dictionary.Add("<!--NAME-->", personalDetail.FirstOrDefault().FirstName);
                dictionary.Add("<!--PWD_URL-->", "" + (new URLsFromConfig()).GetURL("MERCHANT") + "UserLogin/Edit?pUserLoginID=" + userLoginID);

                gateWay.SendEmail(GateWay.EmailGateWays.GANDHIBAGH, GateWay.SenderMail.INFO, GateWay.EMailTypes.PWD_RCVRY, new string[] { pEmailId }, dictionary, true);
