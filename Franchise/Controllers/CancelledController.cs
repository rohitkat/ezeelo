...
namespace Franchise.Controllers
{
    ...
    public class CancelledController : Controller
    {
        ...
        //    catch (Exception ex)
        //    {
        //        throw new BusinessLogicLayer.MyException("[CancelledController][GetFranchiseID]", "Can't find FranchiseID !" + Environment.NewLine + ex.Message);
        //    }
        //    return FranchiseID;
        //}
        ...
        // GET: /Cancelled/
        [SessionExpire]
        [CustomAuthorize(Roles = "Cancelled/CanRead")]
        public ActionResult Index()
        {
            ...
            try
            {
                ...
                foreach (var IsDelivery in IsDeliveryOutSource)
                {
                    ...
                    where COD.ShopID.Equals(IsDelivery.ID) && COD.OrderStatus.Equals((int)ORDER_STATUS.CANCELLED)
                    select new
                    {
                        CO.OrderCode,
                        COD.ShopOrderCode,
