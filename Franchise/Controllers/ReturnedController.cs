...
namespace Franchise.Controllers
{
    ...
    public class ReturnedController : Controller
    {
        ...
        //    catch (Exception ex)
        //    {
        //        throw new BusinessLogicLayer.MyException("[ReturnedController][GetFranchiseID]", "Can't find FranchiseID !" + Environment.NewLine + ex.Message);
        //    }
        //    return FranchiseID;
        //}
        // GET: /Returned/
        ...
        public ActionResult Index()
        {
            ...
            try
            {
                ...
                foreach (var IsDelivery in IsDeliveryOutSource)
                {
                    ...
                    where COD.ShopID.Equals(IsDelivery.ID) && COD.OrderStatus.Equals((int)ORDER_STATUS.RETURNED)
                    select new
                    {
                        CO.OrderCode,
                        COD.ShopOrderCode,
