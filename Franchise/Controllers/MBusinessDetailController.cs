...
namespace Franchise.Controllers
{
    ...
    public class MBusinessDetailController : Controller
    {
        ...
        // GET: /BusinessDetail/
        [SessionExpire]
        [CustomAuthorize(Roles = "MBusinessDetail/CanRead")]
        ...
        public ActionResult Edit(long? UserLoginID)
        {
            ...
            long businessDetailID = db.BusinessDetails.Where(x => x.UserLoginID == UserLoginID).Select(x => x.ID).FirstOrDefault();
            ...
            BusinessDetail businessdetail = db.BusinessDetails.Find(businessDetailID);
            if (businessdetail == null)
            {
                return HttpNotFound();
            }
        ...
        // more details see http://go.microsoft.com/fwlink/?LinkId=317598.
        [SessionExpire]
        [CustomAuthorize(Roles = "MBusinessDetail/CanWrite")]
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(string Pincode, [Bind(Include = "ID,UserLoginID,Name,BusinessTypeID,ContactPerson,Mobile,Email,Landline1,Landline2,FAX,Address,PincodeID,Website,YearOfEstablishment,SourceOfInfoID,SourcesInfoDescription,IsActive,CreateDate,CreateBy,ModifyDate,ModifyBy,NetworkIP,DeviceType,DeviceID")] BusinessDetail businessdetail, string YOE)
        {
            try
            {
                ...
                {
                    businessdetail.YearOfEstablishment = null;
                }
                ...
                if (ModelState.IsValid)
                {
                    ...
                    bd.DeviceType = "x";
                    db.SaveChanges();
                    //ModelState.AddModelError("Success Message", "Business Detail Updated Successfully!!");
