...
namespace Franchise.Controllers
{
    ...
    public class InGodownController : Controller
    {
        ...
        //    catch (Exception ex)
        //    {
        //        throw new BusinessLogicLayer.MyException("[InGodownController][GetFranchiseID]", "Can't find FranchiseID !" + Environment.NewLine + ex.Message);
        //    }
        //    return FranchiseID;
        //}
        [SessionExpire]
        [CustomAuthorize(Roles = "InGodown/CanRead")]
        public ActionResult Index()
        {
            ...
            try
            {
                ...
                foreach (var IsDelivery in IsDeliveryOutSource)
                {
                    ...
                    where COD.ShopID.Equals(IsDelivery.ID) && COD.OrderStatus.Equals((int)ORDER_STATUS.IN_GODOWN)
                    select new
                    {
                        CO.OrderCode,
                        COD.ShopOrderCode,
            ...
            catch (BusinessLogicLayer.MyException myEx)
            {
                BusinessLogicLayer.ErrorLog.ErrorLogFile(DateTime.UtcNow.AddHours(5.5).ToShortTimeString()
                    ...
                    + "[InGodownController][GET:Index]" + myEx.EXCEPTION_PATH,
