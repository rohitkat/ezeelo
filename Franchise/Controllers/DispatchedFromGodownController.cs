...
namespace Franchise.Controllers
{
    ...
    public class DispatchedFromGodownController : Controller
    {
        private EzeeloDBContext db = new EzeeloDBContext();

        // GET: /DispatchedFromGodown/
        ...
        //    catch (Exception ex)
        //    {
        //        throw new BusinessLogicLayer.MyException("[DispatchedFromGodownController][GetFranchiseID]", "Can't find FranchiseID !" + Environment.NewLine + ex.Message);
        //    }
        //    return FranchiseID;
        //}
        [SessionExpire]
        [CustomAuthorize(Roles = "DispatchedFromGodown/CanRead")]
        public ActionResult Index()
        {
            ...
            try
            {
                ...
                foreach (var IsDelivery in IsDeliveryOutSource)
                {
                    ...
                    where COD.ShopID.Equals(IsDelivery.ID) && COD.OrderStatus.Equals((int)ORDER_STATUS.DISPATCHED_FROM_GODOWN)
                    select new
                    {
                        CO.OrderCode,
                        COD.ShopOrderCode,
            ...
            catch (BusinessLogicLayer.MyException myEx)
            {
                BusinessLogicLayer.ErrorLog.ErrorLogFile(DateTime.UtcNow.AddHours(5.5).ToShortTimeString()
                    ...
                    + "[DispatchedFromGodownController][GET:Index]" + myEx.EXCEPTION_PATH,
            ...
            catch (Exception ex)
            {
                BusinessLogicLayer.ErrorLog.ErrorLogFile(DateTime.UtcNow.AddHours(5.5).ToShortTimeString()
                    ...
                    + "[DispatchedFromGodownController][GET:Index]",
                    BusinessLogicLayer.ErrorLog.Module.Franchise, System.Web.HttpContext.Current.Server);
            }
            return View(TOVML);
        }
