...
namespace Franchise.Controllers
{
    ...
    public class PlacedController : Controller
    {
        ...
        //    catch (Exception ex)
        //    {
        //        throw new BusinessLogicLayer.MyException("[PlacedController][GetFranchiseID]", "Can't find FranchiseID !" + Environment.NewLine + ex.Message);
        //    }
        //    return FranchiseID;
        //}
        ...
        //    long UserLoginID = Convert.ToInt32(Session["USER_LOGIN_ID"]);
        //    long FranchiseID = 0;
        //    long[] PersonalDetailID=null;
        //    try
        //    {
        //        FranchiseID = GetFranchiseID();
        //        if (UserLoginID > 0 && FranchiseID > 0)
        //        {
        //            PersonalDetailID = (db.Shops.Where(x => x.FranchiseID == FranchiseID).Select(x => x.ID).ToArray());
        //        }
        //    }
        //    catch (Exception ex)
        //    {
        ...
        // GET: /Placed/
        [SessionExpire]
        [CustomAuthorize(Roles = "Placed/CanRead")]
        public ActionResult Index()
        {
            ...
            try
            {
                ...
                where
                        ((from SSS in db.Shops
                          where SSS.FranchiseID == FranchiseID
                            select new {
                                            SSS.ID
                                        }).Contains(new { ID = COD.ShopID })
