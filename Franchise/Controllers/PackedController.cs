...
namespace Franchise.Controllers
{
    ...
    public class PackedController : Controller
    {
        ...
        //    catch (Exception ex)
        //    {
        //        throw new BusinessLogicLayer.MyException("[PackedController][GetFranchiseID]", "Can't find FranchiseID !" + Environment.NewLine + ex.Message);
        //    }
        //    return FranchiseID;
        //}
        // GET: /Packed/
        [SessionExpire]
        [CustomAuthorize(Roles = "Packed/CanRead")]
        public ActionResult Index()
        {
            ...
            try
            {
                ...
                foreach (var IsDelivery in IsDeliveryOutSource)
                {
                    ...
                    where COD.ShopID.Equals(IsDelivery.ID) && COD.OrderStatus.Equals((int)ORDER_STATUS.PACKED)
                    select new
                    {
                        CO.OrderCode,
                        COD.ShopOrderCode,
