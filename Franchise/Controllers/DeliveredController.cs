...
namespace Franchise.Controllers
{
    ...
    public class DeliveredController : Controller
    {
        ...
        //    catch (Exception ex)
        //    {
        //        throw new BusinessLogicLayer.MyException("[DeliveredController][GetFranchiseID]", "Can't find FranchiseID !" + Environment.NewLine + ex.Message);
        //    }
        //    return FranchiseID;
        //}
        // GET: /Delivered/
        [SessionExpire]
        [CustomAuthorize(Roles = "Delivered/CanRead")]
        public ActionResult Index()
        {
            ...
            try
            {
                ...
                foreach (var IsDelivery in IsDeliveryOutSource)
                {
                    ...
                    where COD.ShopID.Equals(IsDelivery.ID) && COD.OrderStatus.Equals((int)ORDER_STATUS.DELIVERED)
                    select new
                    {
                        CO.OrderCode,
                        COD.ShopOrderCode,
