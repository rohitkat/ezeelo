...
{
    public class UpdateShopProfileController : ApiController
    {
        public HttpResponseMessage Get(long UserLoginId, DateTime OpeningTime, DateTime ClosingTime)
        {
            ...
            int outResult = 0;
            BusinessLogicLayer.MerchantApp.UpdateShopProfile(UserLoginId, OpeningTime, ClosingTime, ref outResult);
