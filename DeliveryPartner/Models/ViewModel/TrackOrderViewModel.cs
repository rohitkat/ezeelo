...
namespace DeliveryPartner.Models.ViewModel
{
    ...
    public class TrackOrderViewModel
    {
        ...
        //- Added By Avi Verma. Date : 01-August-2016.
        //- Reason : Requirement for Merchant Copy include Landing Price in case deals with Landing Price,
        //-          else, Reverese calcualtion sale rate.
        //-          Discussed with Reeena Ma'am, Mahesh Sir, Ajit Jain, Vikas Sir, Avi Verma on Date : 30-July-2016. Around 7:30 PM.
        public decimal MerchantCopyLandingPrice { get; set; }
