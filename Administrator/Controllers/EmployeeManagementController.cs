...
{
    /// <summary>
    /// To Create New Employee for any business entity of eZeelo
    /// CRM Employee,
    /// Delivery Partner Employee,
    /// Shop Employee
    /// </summary>
    public class EmployeeManagementController : Controller
    {
       ...
       + "ErrorLog Controller : EmployeeManagementController" + Environment.NewLine);
        ...
        public ActionResult Create()
        {
            try
            {
                ViewBag.Salutation = new SelectList(db.Salutations.OrderBy(x => x.Name), "ID", "Name");
                ViewBag.OwnerType = new SelectList(db.BusinessTypes.OrderBy(x => x.Name), "ID", "Name");
                ...
                if (ModelState.IsValid)
                {
                    using (TransactionScope ts = new TransactionScope())
                    {
                        try
                        {
                            ...
                            string EmployeeCode = GenerateEmployeeCode(OwnerType);
        ...
        public ActionResult Edit(long? id)
        {
            try
            {
                ...
                ViewBag.Salutation = new SelectList(db.Salutations.OrderBy(x => x.Name), "ID", "Name", lEmployeeManagement.SalutationID);
                ...
                ViewBag.OwnerType = new SelectList(db.BusinessTypes.OrderBy(x => x.Name), "ID", "Name", lBusinessType.ID);
        ...
        public ActionResult Edit([Bind(Include = "ID,UserLoginID,EmployeeCode,OwnerID,SalutationID,FirstName,MiddleName,LastName,DOB,Gender,PincodeID,Address,AlternateMobile,AlternateEmail,Mobile,Email,Password,IsActive")] EmployeeManagement employeemanagement, int? Salutation, int? BusinessOwner)
        {
            try
            {
                ...
                if (db.UserLogins.Where(x => x.Email.ToLower() == employeemanagement.Email.ToLower() && x.ID != employeemanagement.ID).Count() > 0)
                {
                    ModelState.AddModelError("Email", "Email Address is Already Exist");
                    return View(employeemanagement);
                }

                if (db.UserLogins.Where(x => x.Mobile.ToLower() == employeemanagement.Mobile.ToLower() && x.ID != employeemanagement.ID).Count() > 0)
                {
                    ModelState.AddModelError("Mobile", "Mobile No is Already Exist");
                    return View(employeemanagement);
                }
        ...
        private void SendEmail(EmployeeManagement employeemanagement)
        {
            try
            {
                ...
                emailParaMetres.Add("<!--ACCOUNT_URL-->","" + (new URLsFromConfig()).GetURL("CUSTOMER") + "login/login");
                emailParaMetres.Add("<!--ORDERS_URL-->", "" + (new URLsFromConfig()).GetURL("CUSTOMER") + "login/login");
        ...
        /// <summary>
        /// Generate Code for Newly creating employee Acoording to employee owner business prefix
        /// </summary>
        ...
        /// <summary>
        /// Create/Insert Employee Personal Detail
        /// </summary>
        /// <param name="employeemanagement"></param>
        /// <param name="ID"></param>
        ...
        /// <summary>
        /// Create / Insert EmployeeLogin Detail
        /// </summary>
        /// <param name="employeemanagement"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Update / Modify EmployeeLogin Detail
        /// </summary>
        /// <param name="employeemanagement"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Update / Modify Employee Personal Detail
        /// </summary>
        /// <param name="employeemanagement"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Update / Modify Employee login Detail
        /// </summary>
        /// <param name="employeemanagement"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// To retrive employee selected detail
        /// </summary>
        /// <param name="employeemanagement"></param>
        /// <returns></returns>
        ...
        public List<SelectListItem> FillGender()
        {
            ...
            return (lData.OrderBy(x => x.Text).ToList());
        }
        ...
        /// </summary>
        /// <param name="businessTypeID">ownertypeid</param>
        /// <returns></returns>
        public JsonResult getOwnerID(int? businessTypeID)
        {
            ...
            return Json(lownerType.OrderBy(x => x.Name), JsonRequestBehavior.AllowGet);
        }
        /// <summary>
        /// to check email address is existing or not 
        /// </summary>
        ...
        /// <summary>
        /// to check mobile no is existing or not 
        /// </summary>
        /// <param name="strEmail"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// to check modified email address is existing or not 
        /// </summary>
        /// <param name="strEmail"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// to check modified mobile no exists or not 
        /// </summary>
        /// <param name="strEmail"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// retrive list of owner name and id for filling dropdown
        /// </summary>
        /// <param name="businessTypeID">businesstype</param>
        /// <returns></returns>
        public List<OwnerDetailByPrefix> FillOwnerID(int? businessTypeID)
        {
            ...
            lownerType = objODP.OwnerDetail(businessTypeID, System.Web.HttpContext.Current.Server);
            return lownerType.OrderBy(x => x.Name).ToList();
        }

        /// <summary>
        /// to retive list of employee of selected owner
        /// </summary>
        /// <param name="businessTypeID">businesstype</param>
