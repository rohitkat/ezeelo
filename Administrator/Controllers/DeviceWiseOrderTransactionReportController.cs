...
{
    public class DeviceWiseOrderTransactionReportController : Controller
    {
        ...
        //
        // GET: /DeviceWiseOrderTransactionReport/
        public ActionResult Index()
        {
            ...
            catch (BusinessLogicLayer.MyException myEx)
            {
                ...
                BusinessLogicLayer.ErrorLog.ErrorLogFile(DateTime.UtcNow.AddHours(5.5).ToShortTimeString()
                    ...
                    + "[DeviceWiseCustomerOrderReportController][GET:Index]" + myEx.EXCEPTION_PATH,
            ...
            catch (Exception ex)
            {
                ...
                BusinessLogicLayer.ErrorLog.ErrorLogFile(DateTime.UtcNow.AddHours(5.5).ToShortTimeString()
                    ...
                    + "[DeviceWiseCustomerOrderReportController][GET:Index]",
                    BusinessLogicLayer.ErrorLog.Module.Administrator, System.Web.HttpContext.Current.Server);
                return View();
            }
            //return View();
        ...
        public ActionResult GetReport(int page, int pagecount, string fromDate, string toDate, long? FranchisesID, long? DeviceID)
        {
            try
            {
                if (DeviceID == 1)
                ...
                int TotalCount = 0;
                int TotalPages = 0;
                ViewBag.FranchisesID = FranchisesID;
                int pageNumber = page;
                ...
                try
                {
                    ...
                    if (FranchisesID != 0 && FranchisesID!=null)
                    {
                        sqlComm.Parameters.AddWithValue("@FranchiseID", SqlDbType.Int).Value = FranchisesID;
                    }
                    else
                    {
                        sqlComm.Parameters.AddWithValue("@FranchiseID", SqlDbType.Int).Value = null;
                    }
                    ...
                    {
                       sqlComm.Parameters.AddWithValue("@Devicetype", SqlDbType.DateTime).Value = string.Empty;
                    }
        ...
        public ActionResult Export(string fromDate, string toDate, int option, int print, long? FranchisesID, long? DeviceID)
        {
            try
            {
                List<OrderTransactionReportViewModel> OrderReport = new List<OrderTransactionReportViewModel>();
                OrderReport = this.Getdata(fromDate, toDate, FranchisesID, DeviceID);
                if (print == 1)
                {
            ...
            catch (BusinessLogicLayer.MyException myEx)
            {
                ...
                BusinessLogicLayer.ErrorLog.ErrorLogFile(DateTime.UtcNow.AddHours(5.5).ToShortTimeString()
                    + Environment.NewLine + myEx.EXCEPTION_MSG + Environment.NewLine
                    + "[DeviceWiseOrderTransactionReportController][POST:GetReport]" + myEx.EXCEPTION_PATH,
                    BusinessLogicLayer.ErrorLog.Module.Administrator, System.Web.HttpContext.Current.Server);
            }
            catch (Exception ex)
            {
                ...
                BusinessLogicLayer.ErrorLog.ErrorLogFile(DateTime.UtcNow.AddHours(5.5).ToShortTimeString()
                    + Environment.NewLine + ex.Message + Environment.NewLine
                    + "[DeviceWiseOrderTransactionReportController][POST:GetReport]",
                    BusinessLogicLayer.ErrorLog.Module.Administrator, System.Web.HttpContext.Current.Server);
            }
        ...
        public List<OrderTransactionReportViewModel> Getdata(string fromDate, string toDate, long? FranchisesID, long? DeviceID)
        {
