//-----------------------------------------------------------------------
// <copyright file="BulkController" company="Ezeelo Consumer Services Pvt. Ltd.">
...
namespace Administrator.Controllers
{
    ...
    public class BulkController : Controller
    {
        ...
        public ActionResult Index(long? ShopID,long ? FranchiseID,string ShopName)
        {
        ...
        /// <summary>
        /// Method to get Shop from Franchise
        /// </summary>
