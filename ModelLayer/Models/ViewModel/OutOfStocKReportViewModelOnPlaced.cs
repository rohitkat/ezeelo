...
{
    public class OutOfStocKReportViewModelOnPlaced
    {
        public DateTime? OtOfStockDate { get; set; }
    ...
    public class OutOfStocKReportViewModelOnPlaced_Detail
    {
        public string Cat1 { get; set; }
        public string Cat2 { get; set; }
        public string Cat3 { get; set; }
    ...
    public class ProductReorderExport1
    {
