...
{
    public class StockComponentMap : EntityTypeConfiguration<StockComponent>
    {
        public StockComponentMap()
        {
            // Primary Key
            this.HasKey(t => t.ID);
            ...
            this.HasRequired(t => t.Component)
                .WithMany(t => t.StockComponents)
                .HasForeignKey(d => d.ComponentID);
            this.HasRequired(t => t.PersonalDetail)
                .WithMany(t => t.StockComponents)
                .HasForeignKey(d => d.CreateBy);
            this.HasOptional(t => t.PersonalDetail1)
                .WithMany(t => t.StockComponents1)
