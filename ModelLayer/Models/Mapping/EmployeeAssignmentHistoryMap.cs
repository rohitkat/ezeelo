...
namespace ModelLayer.Models.Mapping
{
   ...
   /* public class EmployeeAssignmentHistoryMap : EntityTypeConfiguration<EmployeeAssignmentHistory>
    {
        public EmployeeAssignmentHistoryMap()
        {
            // Primary Key
            this.HasKey(t => t.ID);
            ...
            this.ToTable("EmployeeAssignmentHistory");
            ...
            // Relationships
            this.HasOptional(t => t.EmployeeAssignment)
                .WithMany(t => t.EmployeeAssignmentHistory)
