...
{
    public class TempShopStockMap : EntityTypeConfiguration<TempShopStock>
    {
        public TempShopStockMap()
        {
            // Primary Key
            this.HasKey(t => t.ID);
            ...
            this.HasRequired(t => t.PersonalDetail)
                .WithMany(t => t.TempShopStocks)
                .HasForeignKey(d => d.CreateBy);
            this.HasOptional(t => t.PersonalDetail1)
                .WithMany(t => t.TempShopStocks1)
                .HasForeignKey(d => d.ModifyBy);
            this.HasRequired(t => t.TempProductVarient)
                .WithMany(t => t.TempShopStocks)
                .HasForeignKey(d => d.ProductVarientID);
            this.HasRequired(t => t.TempShopProduct)
                .WithMany(t => t.TempShopStocks)
